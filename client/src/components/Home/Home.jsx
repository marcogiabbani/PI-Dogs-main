...
export default function Home (){
    ...
    return ( 
        ...
        <div>
            ...
            {/* <select onClick={event => handleWeightSort(event)}>
                <option value="weigth" >Weigth</option>
                <option value="asc" onClick={event => handleWeightSort(event)}>Weigth Ascendant</option>
                <option value="desc" onClick={event => handleWeightSort(event)}>Weigth Descendant</option>
            </select> */}
