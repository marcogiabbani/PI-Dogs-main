            ...
            <ul className="navbar-nav">
                ...
                <li className="nav-item">
                    <a href="#" className="nav-link">
                        ...
                        <span className="link-text">DOG APP</span>
                    </a>
                </li>
                ...
                <li className="nav-item">
                    <a href="#" className="nav-link">
                        ...
                        <span className="link-text">Alphabetical order Ascendant</span>
                    </a>
                </li>
                ...
                <li className="nav-item">
                    <a href="#" className="nav-link">
                        ...
                        <span className="link-text">Alphabetical order Descendant</span>
                    </a>
                </li>
                ...
                <li className="nav-item">
                    <a href="#" className="nav-link">
                        ...
                        <span className="link-text">Weigth Ascendant</span>
                    </a>
                </li>
                ...
                <li className="nav-item">
                    <a href="#" className="nav-link">
                        ...
                        <span className="link-text">Weigth Descendant</span>
                    </a>
                </li>
                ...
                <li className="nav-item">
                    ...
                    <span className="link-text">All breeds</span>
                    </a>
                </li>
                ...
                <li className="nav-item">
                    <a href="#" className="nav-link">
                        ...
                        <span className="link-text">Created breeds</span>
                    </a>
                </li>
                ...
                <li className="nav-item">
                    <a href="#" className="nav-link">
                        ...
                        <span className="link-text">Api breeds</span>
                    </a>
                </li>
                <li className="nav-item">
                    <a href="#" className="nav-link">
